...
public class ImmutableListTest {
    ...
    public void appendConsConsDifferentLength_1() {
        ...
        final ImmutableList expected = new Cons(1, new Cons(2, new Cons(1, new Cons(-1, new Cons(1, new Nil())))));
        assertEquals(expected, first.append(second));
    ...
    public void appendConsConsDifferentLength_2() {
        ...
        final ImmutableList expected = new Cons(2, new Cons(1, new Cons(-1, new Cons(-2, new Cons(-3, new Nil())))));
        assertEquals(expected, first.append(second));
